...
The `report` command requires R (≥ 4.4.0) and a set of R packages (listed in the [report command documentation](./docs/commands.md#the-report-command)). Check or install the required R packages with:
```bash
comms r-utils check
